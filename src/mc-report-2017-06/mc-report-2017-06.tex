...
\begin{description}[itemsep=0.15em,topsep=0.1em]
...
\footnotesize
The progress of each section is recorded here.  I have provided a citation where a section is documented in an article but has not yet been included in the thesis.  I also note where technical and mathematic work is still in development and documentation has yet to be written.

\subsubsection*{1. Introduction}
\begin{tabularx}{\linewidth}{>{\hsize=1.3in}X X}
Not started & This project is motivated by the need for alternative horizontal and vertical representations of the Earth and its terrain
\end{tabularx}
...
\cite{shaw-weller2016} & Describe the nonhydrostatic model with Lorenz staggering
\end{tabularx}
...
\addlinespace[0.5em]
	...
	\citet{shaw2017} & \quad\textbullet\enspace transport test over steep slopes \\
...
\begin{tabularx}{\linewidth}{>{\hsize=1.3in}X X}
	...
	In development & Describe the necessary changes to the nonhydrostatic model \\
\addlinespace[0.5em]
&  Describe the new two-dimensional standing waves test case and compare results: \\
\addlinespace[0.2em]
...
\begin{tabularx}{\linewidth}{>{\hsize=1.3in}X X}
Not started &  Document a new advective-form transport scheme for potential temperature, based on the flux-form cubicFit scheme \\
\addlinespace[0.5em]
Not started & Compare accuracy with the simple transport scheme from chapter 5, using the tracer transport test from \citep{shaw2017} \\
\addlinespace[0.5em]
