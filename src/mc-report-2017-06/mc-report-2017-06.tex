...
Third, there are overlaps between my first and second articles, and the second article supercedes parts of the first.  As such, there is no one-to-one mapping between articles and thesis chapters, and reorganisation and some new prose and new figures will be required for the thesis.
Finally, I have completed two masters modules, one of which was assessed.

\TODO{timeline of work}
...
\subsubsection*{5. Generalisation of the Charney--Phillips staggering}
...
\begin{itemize}[itemsep=0.1em]
	...
	\item Describe the \TODO{simple} advective-form transport scheme
...
\noindent The final chapter demonstrates the efficacy of combining all three work items: the slanted cell mesh, the cubicFit scheme, and the generalised Charney--Phillips formulation.
\begin{itemize}
	\item Document the new advective-form transport scheme for potential temperature, adopting methods used in the cubicFit scheme
	\item Evaluate the $\theta$ transport scheme using a new variant of the \citet{schaer2002} gravity waves test that incorporates standing waves that excite the Lorenz computational mode.  Results should be compared between
	\begin{itemize}
		\item \TODO{simple and advanced} advective-form transport schemes
		\item Lorenz and Charney--Phillips model variants
		\item terrain-following, cut cell and slanted cell meshes
	\end{itemize}
	\item \TODO{cubicFit won't really feature here, although it might still be used for transporting momentum.  we could use it to transport a passive tracer?}
\end{itemize}
