...
First, the cells of latitude-longitude meshes are very small near the Earth's poles, causing a bottleneck in parallel computation \citep{staniforth-thuburn2012} and placing severe time-step constraints on explicit Eulerian methods \TODO{citation? or remove this clause?}.
...
Unlike latitude-longitude meshes that are everywhere orthogonal, quasi-uniform meshes are never entirely orthogonal, and they can produce grid imprinting errors and excite computational modes \citep{weller2012}.
