...
The project focuses on two aspects: first, how to model orographic flows accurately on arbitrary meshes and, second, how orography is best represented by a mesh.

Accurately modelling atmospheric flows over orography on arbitrary meshes presents many challenges that include the accurate advection of quantities, especially near the lower boundary, and the avoidance of unphysical solutions in the vertical balance between pressure and temperature.  Addressing these two particular challenges will form part of my PhD research.
